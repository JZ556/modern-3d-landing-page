            ...
            <div className='container'>
                ...
                <div className='relative '>
                    <div className='relative z-1 flex items-center h-[39rem] mb-5 p-8 border border-n-1/10 rounded-3xl overflow-hidden lg:p-20 xl:h-[46rem] '>
                        ...
                        <Generating className='absolute left-4 right-4 bottom-4 lg:left-1/2 border border-n-1/10 lg:bottom-8 lg:right-auto lg:-translate-x-1/2' />

                    </div>
                    <div className='relative z-1 grid gap-5 lg:grid-cols-2' >
                        <div className='relative min-h-[39rem] border border-n-1/10 overflow-hidden rounded-3xl '>
                            <div className='absolute inset-0'>
                                <img src={service2} className='w-full h-full object-cover md:object-right' width={630} height={750} alt="robot" />
                            </div>
                            <div className='absolute inset-0 flex flex-col justify-end p-8 bg-gradient-to-b from-n-8/0 to-n-9/90 lg:p-15 '>
                        ...
                        <div className='p-4 bg-n-7 rounded-3xl overflow-hidden lg:min-h-[46rem] '>
                            ...
                            <div className='relative h-[20rem] bg-n-8 rounded-xl overflow-hidden md:h-[25rem]'>
                                <img src={service3} className='w-full h-full object-cover' width={120} height={400} alt="robot2" />
                                <VideoChatMessage />
                                <VideoBar />
                            </div>
                        </div>
